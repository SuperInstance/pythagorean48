...
Exact 6-bit vector encoding for ARM64 edge. 8 components per uint64, zero drift, 80M queries/s on Jetson.
...
```bash
git clone https://github.com/SuperInstance/pythagorean48
cd pythagorean48
```
